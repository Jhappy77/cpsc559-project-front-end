    ...
    return (
        <Flex backgroundImage='linear-gradient(to bottom right, green, yellow)' width='100%' height='calc(100vh)' alignItems='center' textAlign='center' justifyContent='center'>
            <Flex alignItems='center' maxW="md" margin="4">
                <VStack>
                    <Logo size={["32px", "50px"]} />
                    <Question id="1" title='Question #1' text='Da minion or da bob fo today? Some will say da minion, others will tell you that it is da bob. But who can really say?'/>
